...
def process_commands(token, component, testType, institution, runNumber, flag, problem, properties, results, comments,
                     uploadedfile):
    # input_dir = Path(INPUT_FLD)
    processed_dir = Path(PROCESSED_FLD)
    if not processed_dir.is_dir():
        os.makedir("processed")
    response_json = upload_results(token, component, testType, institution, runNumber, flag, problem, properties,
                                   results, comments)
...
def Database_upload(component, testType, institution, runNumber, flag, problem, properties, results, comments,
                    uploadedfile):
    try:
        ...
        print("")
        process_commands(token_json["id_token"], component, testType, institution, runNumber, flag, problem, properties,
                         results, comments, uploadedfile)
